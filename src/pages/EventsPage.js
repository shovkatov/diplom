...
export const EventsPage = () => {
    ...
    const events = state.filter(i=>i.category==='event')
    ...
    return <div className="pb-28 sm:pb-16">
        <div className="flex w-full justify-center"><h2
            className=" px-3 bg-slate-200 inline-block text-2xl font-bold uppercase translate-y-4">Мероприятие</h2>
        </div>
                ...
                <div key={i.id} className="sm:w-1/4 w-full p-2">
                    <div className="bg-white rounded overflow-hidden pb-2">
                        ...
                        <div className="h-20 px-4">
                            ...
                            <p>{i.place}</p>
                            <p className="text-2xl font-bold">{i.price} UZS</p>
                        </div>
                    </div>
                </div>
            ))}
